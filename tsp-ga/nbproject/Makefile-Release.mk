...
${OBJECTDIR}/chromosome.o: chromosome.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chromosome.o chromosome.c
...
${OBJECTDIR}/tspController.o: tspController.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Werror -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tspController.o tspController.c
